...
(* TODO add a function to calculate the likelihood or log likelihood and a test to make sure it's increasing.*)
(* TODO add outer loop for trying different initializations of mixing parameters*)
(* TODO add outer loop for erasing the first motif found and finding a second*)
...
MMIteration[input_, motifLength_, motifPseudocounts_, initialMotifPrior_, randomInitialPFM_,backgroundFreqs_, 
	...
	Module[{PFM=randomInitialPFM, oldPFM, motifPrior=initialMotifPrior, posteriors, i = 1},
		Do[oldPFM=PFM;
